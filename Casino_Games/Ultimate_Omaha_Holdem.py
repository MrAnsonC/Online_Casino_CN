...
def save_progressive(jackpot):
    ...
    found = False
    for item in data:
        if item.get('Games') == 'UTH_&_UOH_&_CHE_&_HUH':  # 修改为UOH
            item['jackpot'] = jackpot
            found = True
            break
    
    if not found:
        data.append({"Games": "UTH_&_UOH_&_CHE_&_HUH", "jackpot": jackpot})  # 修改为UOH
...
class UOHGUI(tk.Tk):  # 修改类名为UOHGUI
    ...
    def show_game_instructions(self):
        ...
        headers = ["牌型", "盲注", "累进大奖#"]
        odds_data = [
            ("皇家同花顺", "500:1", "100%累进大奖/$100,000"),
            ("四条", "50:1", "10%累进大奖/$10,000"),
            ("同花顺", "10:1", "$3,000"),
            ("葫芦", "3:1", "$500"),
            ("同花", "1.5:1", "$350"),
            ("顺子", "1:1", "-"),
    ...
    def _create_widgets(self):
        ...
        dealer_frame.place(x=90, y=5, width=520, height=210)  # 调整宽度以适应更大的卡片
        ...
        player_frame.place(x=90, y=500, width=520, height=210)  # 调整宽度以适应更大的卡片
