...
class CrazyFourGame:
    ...
    def reset_game(self):
        ...
        self.cards_revealed = {
            ...
            "dealer": [False, False, False, False, False, False]
        }
        # 记录牌序和切牌位置
...
class CrazyFourGUI(tk.Tk):
    def __init__(self, initial_balance, username):
        ...
        self.ace_plus_bet_var = tk.IntVar(value=0)  # Ace+下注变量
    ...
    def _create_widgets(self):
        ...
        dealer_frame.place(x=30, y=20, width=720, height=250)  # 加宽以适应6张更大的牌
        ...
        # Ante 和 Ace+ 在同一行（第一行）
        ante_ace_frame = tk.Frame(bet_frame, bg='#2a4a3c')
        ante_ace_frame.pack(fill=tk.X, padx=40, pady=3)

        # Ante 部分
        ante_label = tk.Label(ante_ace_frame, text="底注:", font=('Arial', 14), bg='#2a4a3c', fg='white')
        ante_label.pack(side=tk.LEFT)

        self.ante_var = tk.StringVar(value="0")
        self.ante_display = tk.Label(ante_ace_frame, textvariable=self.ante_var, font=('Arial', 14), 
        ...
        # 添加间距
        tk.Label(ante_ace_frame, text="   ", bg='#2a4a3c').pack(side=tk.LEFT, padx=10)

        # Ace+ 部分
        ace_plus_label = tk.Label(ante_ace_frame, text="Ace+:", font=('Arial', 14), bg='#2a4a3c', fg='white')
        ace_plus_label.pack(side=tk.LEFT)

        self.ace_plus_var = tk.StringVar(value="0")
        self.ace_plus_display = tk.Label(ante_ace_frame, textvariable=self.ace_plus_var, font=('Arial', 14), 
                                        bg='white', fg='black', width=5, relief=tk.SUNKEN, padx=5)
