...
<style>
    ...
    .uth-content .uth-table td:nth-child(3) {
        text-align: right;
    }
    .uth-content .uth-table th:nth-child(4),
    .uth-content .uth-table td:nth-child(4) {
        text-align: center;
    }
    .uth-content .uth-table th:nth-child(5),
    .uth-content .uth-table td:nth-child(5) {
        text-align: left;
    }
    ...
    .uth-content .uth-table th:nth-child(2),
    ...
    .uth-content .uth-table th:nth-child(6),
    .uth-content .uth-table td:nth-child(6) {
        width: 12%;
    }
    .uth-content .uth-table th:nth-child(7),
...
<script>
    // ===== Casino Hold'em 数据加载逻辑（与 UTH 完全一致，仅数据源不同） =====
    (function() {
        const DATA_URL = './Json/Casino_Holdem.json';   // 唯一修改点
        let allRecords = [];
        ...
        function renderUthTable() {
            ...
            for (const game of displayRecords) {
                ...
                const isFold = game.fold === true || (game.result && game.result.winner === 'fold');
        ...
        async function loadData() {
            try {
                ...
                console.error('Casino Holdem load error:', err);
