...
<div class="huh-content">
    ...
    <div class="dashboard-grid">
        ...
        <div class="card">
            ...
            <div class="stats-grid-2">
                ...
                <div class="stat-item">
                    <div class="stat-value green" id="h-winrate">0%</div>
        ...
        <div class="card">
            ...
            <div class="stats-grid-4">
                <div class="stat-item">
                    <div class="stat-value green" id="h-player-wins">0</div>
                    <div class="stat-label">玩家胜</div>
                    <div class="stat-sub" id="h-player-pct">0%</div>
                </div>
                <div class="stat-item">
                    <div class="stat-value red" id="h-dealer-wins">0</div>
                    <div class="stat-label">庄家胜</div>
                    <div class="stat-sub" id="h-dealer-pct">0%</div>
                </div>
                <div class="stat-item">
                    <div class="stat-value" style="color:#ffd700;" id="h-pushes">0</div>
                    <div class="stat-label">平局</div>
                    <div class="stat-sub" id="h-push-pct">0%</div>
                </div>
                <div class="stat-item">
                    <div class="stat-value" style="color:#aaa;" id="h-folds">0</div>
                    <div class="stat-label">弃牌</div>
                    <div class="stat-sub" id="h-fold-pct">0%</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card" style="margin-bottom:30px;">
        ...
        <div class="huh-table-wrap">
            <table class="huh-table" id="h-history-table">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>时间</th>
...
<style>
    /* 继承主框架样式，增加模态框和细节布局 */
    .huh-content .dashboard-grid {
        display: grid;
        grid-template-columns: repeat(auto-fit, minmax(320px, 1fr));
        gap: 25px;
        margin-bottom: 35px;
    }
    .huh-content .stats-grid-2 {
        display: grid;
        grid-template-columns: repeat(2, 1fr);
        gap: 20px;
    }
    .huh-content .stats-grid-4 {
        display: grid;
        grid-template-columns: repeat(4, 1fr);
        gap: 16px;
    }
    .huh-content .stat-item {
    ...
    .huh-content .stat-item:hover {
        background: rgba(50,70,95,0.7);
        transform: scale(1.02);
    }
    .huh-content .stat-value {
        font-size: 2.4rem;
        font-weight: 700;
        color: #ffcc00;
    ...
    .huh-content .card:hover {
        transform: translateY(-3px);
    }
    .huh-content .card-header {
        display: flex;
        align-items: center;
        margin-bottom: 18px;
        padding-bottom: 12px;
    ...
    .huh-content .card-header i {
        font-size: 1.6rem;
        margin-right: 14px;
        color: #ffcc00;
    }
    .huh-content .card-header h2 {
        font-size: 1.5rem;
        color: #e0e0e0;
        font-weight: 600;
    }
    ...
    /* 表格样式 */
    .huh-content .huh-table-wrap {
        overflow-x: auto;
        margin-top: 6px;
    }
    .huh-content .huh-table {
        table-layout: fixed;
        width: 100%;
    }
    .huh-content .huh-table th:nth-child(3),
    .huh-content .huh-table td:nth-child(3) {
        text-align: right;
    }
    .huh-content .huh-table th:nth-child(4),
    .huh-content .huh-table td:nth-child(4) {
        text-align: center;
    }
    .huh-content .huh-table th:nth-child(5),
    .huh-content .huh-table td:nth-child(5) {
        text-align: left;
    }
    .huh-content .huh-table th:nth-child(1),
    .huh-content .huh-table td:nth-child(1) {
        width: 6%;
    }
    .huh-content .huh-table th:nth-child(2),
    .huh-content .huh-table td:nth-child(2) {
        width: 16%;
    }
    .huh-content .huh-table td:nth-child(3) {
        text-align: right;
    ...
    .huh-content .huh-table th:nth-child(6),
    .huh-content .huh-table td:nth-child(6) {
        width: 12%;
    }
    .huh-content .huh-table th:nth-child(7),
    .huh-content .huh-table td:nth-child(7) {
        width: 10%;
    }
    .huh-content .huh-table th,
    .huh-content .huh-table td {
        padding: 10px 8px;
    ...
    .huh-content .huh-table tr:hover td {
        background: rgba(255,204,0,0.06);
    }
    .huh-content .cards-mini {
        font-family: 'Segoe UI', monospace;
        font-weight: 600;
        letter-spacing: 0.5px;
        font-size: 0.85rem;
    }
    .huh-content .winnings-positive {
        color: #4ecdc4;
        font-weight: 700;
    }
    .huh-content .winnings-negative {
        color: #ff6b6b;
        font-weight: 700;
    }
    .huh-content .winnings-zero {
        color: #8da0b3;
    }
    .huh-content .huh-result-badge {
    ...
    .huh-content .huh-result-badge.win {
        background: rgba(78,205,196,0.25);
        color: #4ecdc4;
    }
    .huh-content .huh-result-badge.lose {
        background: rgba(255,107,107,0.25);
        color: #ff6b6b;
    }
    .huh-content .huh-result-badge.push {
        background: rgba(255,215,0,0.2);
        color: #ffd700;
    }
    .huh-content .huh-result-badge.fold {
    ...
    @media (max-width: 768px) {
        ...
        .huh-content .detail-layout {
            flex-direction: column;
        }
        .huh-content .detail-right {
            width: 100%;
        }
        .huh-content .huh-table {
            font-size: 0.78rem;
...
<script>
    // ===== HUH 数据加载逻辑（包含模态框事件与分页） =====
    (function() {
        const HUH_URL = './Json/Heads_Up_Holdem.json';
        let allRecords = [];
        ...
        function getResultBadge(winner, isFold) {
            if (winner === 'fold') return '<span class="huh-result-badge fold">弃牌</span>';
            if (winner === 'player') return '<span class="huh-result-badge win">玩家胜</span>';
            if (winner === 'dealer') return '<span class="huh-result-badge lose">庄家胜</span>';
            if (winner === 'push') return '<span class="huh-result-badge push">平局</span>';
            return '<span class="huh-result-badge fold">—</span>';
        }

        function renderHuhTable() {
            const tbody = document.getElementById('h-history-body');
            ...
            document.querySelectorAll('#h-history-body tr').forEach(row => {
        ...
        function updateStats(historyRecord) {
            ...
            document.getElementById('h-winrate').textContent = winRate.toFixed(1) + '%';
            document.getElementById('h-player-wins').textContent = playerWins;
            document.getElementById('h-dealer-wins').textContent = dealerWins;
            document.getElementById('h-pushes').textContent = pushes;
            document.getElementById('h-folds').textContent = folds;
            document.getElementById('h-player-pct').textContent = playerPct.toFixed(1) + '%';
            document.getElementById('h-dealer-pct').textContent = dealerPct.toFixed(1) + '%';
            document.getElementById('h-push-pct').textContent = pushPct.toFixed(1) + '%';
            document.getElementById('h-fold-pct').textContent = foldPct.toFixed(1) + '%';
        }

        async function loadHuh() {
            try {
                const resp = await fetch(HUH_URL);
                ...
                console.error('HUH load error:', err);
                document.getElementById('h-history-body').innerHTML =
